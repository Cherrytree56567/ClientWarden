...
class AcrylicCompositor
{
	public:
		...
		bool CreateOverlayLayer(IDXGISwapChain1** ppSwapChain);

    	ID3D11Device* GetD3DDevice() { return d3d11Device.Get(); }
    	ID3D11DeviceContext* GetD3DContext() { return d3d11Context.Get(); }
